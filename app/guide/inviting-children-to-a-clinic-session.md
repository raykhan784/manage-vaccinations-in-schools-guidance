...
Mavis uses all of the following rules to work out, for each programme, which children can be invited:

- they are eligible based on their age
- they are not already vaccinated
