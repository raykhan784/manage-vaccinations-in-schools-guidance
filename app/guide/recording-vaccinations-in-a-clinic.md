...
As with school sessions, the **Record vaccinations** tab only shows children for whom all the following points apply:
...
Find out more about [registering attendance](/guide/attendance/).
